            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    ...
                    <div className="relative p-1 rounded-full overflow-hidden group w-full sm:w-auto cursor-pointer shadow-[0_0_40px_rgba(59,130,246,0.5)] hover:scale-110 hover:shadow-[0_0_50px_rgba(59,130,246,0.7)] transition-all duration-300">
                        ...
                        <button 
                            onClick={toggleCall}
                            className={`w-full relative ${isCalling ? 'bg-red-500 text-white hover:bg-red-600' : 'bg-primary text-background hover:bg-white'} transition-colors duration-300 rounded-full py-4 px-8 font-bold text-lg flex items-center justify-center gap-3 z-10 shadow-lg`}
                        >
                            {isConnecting ? (
                                <>
